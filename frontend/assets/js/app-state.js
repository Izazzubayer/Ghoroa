...
(function (window) {
    ...
    class GhoroaStore {
        ...
        initStore() {
            ...
            localStorage.setItem('ghoroa_products', JSON.stringify(REAL_GHOROA_PRODUCTS));
        }
        ...
        getProducts() { return JSON.parse(localStorage.getItem('ghoroa_products') || JSON.stringify(REAL_GHOROA_PRODUCTS)); }
