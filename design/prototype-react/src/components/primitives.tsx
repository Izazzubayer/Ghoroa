...
/** Gold diamond rule used between sections and inside eyebrows. */
...
/** Small caps label with flanking diamonds — matches the reference eyebrows. */
...
/** Ghost button with gold hairline border and fill-on-hover. */
...
/** Image inside a Mughal arch with a gold double-hairline frame. */
