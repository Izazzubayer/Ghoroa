// Source: Watermelon UI `card-split-accordian`
//   npx shadcn@latest add https://registry.watermelon.sh/r/card-split-accordian.json
// Kept: the split-border geometry and spring layout animation.
// Changed for Ghoroa: forest/gold palette, full-width, and the accordion a11y contract
// (aria-expanded / aria-controls, and collapsed panels removed from the a11y tree).
  ...
  return (
    <motion.li layout>
      ...
      >
        <h3>
          ...
          >
            ...
            <motion.span animate={{ rotate: isOpen ? 45 : 0 }} className="shrink-0 text-gold-deep">
              {/* Plus/close mark — rotates to an ✕ when open */}
        ...
        {/* `inert` keeps collapsed copy out of the a11y tree and off the tab order,
            which a height-0 container alone does not do. */}
        <motion.div
          id={panelId}
          role="region"
