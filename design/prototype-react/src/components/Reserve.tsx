...
const INFO = [
  { label: 'Hours', lines: ['Daily · 12:00 – 23:00'] },
  { label: 'Call', lines: ['+880 1711 223344'] },
  { label: 'Find us', lines: ['Gulshan 2, Dhaka'] },
]
...
export default function Reserve() {
  return (
    ...
    >
      {/* Concentric arch ornament instead of a photo — guarantees text contrast. */}
      <svg
        aria-hidden
      ...
      <div className="mx-auto flex max-w-3xl flex-col items-center px-5 text-center">
        <Reveal className="flex flex-col items-center">
          ...
          <p className="mt-6 max-w-lg text-[0.95rem] leading-[1.8] text-cream/85">
            Whether it's a quiet dinner or a family gathering, we'll keep a seat warm. Call ahead for parties of six or
            more.
          </p>
          <div className="mt-9 flex flex-wrap justify-center gap-4">
            <GoldButton href="tel:+8801711223344">Call to reserve</GoldButton>
            <a
